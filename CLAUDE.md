...
- The theme editors are `Adw.Dialog`. They were `Adw.Window` for a taskbar entry, but they were also modal and transient, so they never behaved like the independent windows that justified it.
